...
window.I18N = {
  en: {
    ...
    "hero.lede": "I build LLM systems end to end — multi&#8209;agent orchestration, semantic vector search, multi&#8209;provider model routing, and the CI/CD and quality gates that keep them honest. Seven shipped projects, three hackathons, and a habit of measuring what I claim.",
    ...
    "sec.edu": "Education &amp; recognition",
    "edu.title": "The formal half.",
    ...
    "hero.lede": "Rakennan LLM-järjestelmiä alusta loppuun — moniagenttiorkestrointia, semanttista vektorihakua, usean palveluntarjoajan mallireititystä sekä CI/CD- ja laatuportit, jotka pitävät ne rehellisinä. Seitsemän julkaistua projektia, kolme hackathonia ja tapa mitata se, minkä väitän.",
    ...
    "sec.edu": "Koulutus ja tunnustukset",
    "edu.title": "Muodollinen puoli.",
